...
namespace MCOP.EventListeners.Attributes;
...
public sealed class AsyncEventListenerAttribute : Attribute
{
    ...
    public void Register(Bot bot, MethodInfo mi)
    {
        ...
        switch (this.EventType) {
            ...
            case DiscordEventType.CommandErrored:
                bot.CNext.CommandErrored += OnEventWithArgs;
                break;
            case DiscordEventType.CommandExecuted:
                bot.CNext.CommandExecuted += OnEventWithArgs;
                break;
            ...
            case DiscordEventType.MessageAcknowledged:
                bot.Client.MessageAcknowledged += OnEventWithArgs;
                break;
