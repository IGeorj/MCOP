...
export const VideoPlayer: React.FC<VideoPlayerProps> = ({ path, className, onClose }) => {
    ...
    }, [isFullscreen, togglePlay, duration, toggleFullscreen, onClose]);
    ...
    return (
        <div ref={containerRef} className={`relative w-full h-full bg-black focus:outline-none ${className || ''}`} onKeyDown={onKeyDown} tabIndex={0}>
