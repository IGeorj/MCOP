...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="cursor-pointer relative h-1.5 w-full grow overflow-hidden rounded-full bg-primary">
      <SliderPrimitive.Range className="cursor-pointer absolute h-full bg-color-primary" />
