...
export function RoleItem({ role, onToggle }: RoleItemProps) {
    ...
    return (
        <div onClick={onToggle} className="text-primary-reversed group/item flex items-center justify-between p-3 rounded-lg border border-transparent hover:bg-accent dark:hover:bg-accent/50 transition-all duration-200 cursor-pointer transform hover:scale-[1.01] active:opacity-70">
